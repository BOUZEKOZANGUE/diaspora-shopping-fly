...
<body>
    <div class="header">
        <h1>DSF Express</h1>
        <h2>Confirmation d'Expédition - Nouveau Client</h2>
    </div>
    ...
    <div class="section">
        ...
        <div class="info-box">
            ...
            <p><strong>Mot de passe:</strong> <span class="important">{{ $shipment['user']['password'] }}</span></p>
            <p class="important">Conservez précieusement ces informations!</p>
        </div>
    </div>
