        ...
        <div class="relative bg-gradient-to-r from-[#0077be] to-[#005c91] overflow-hidden">
            ...
            <div class="pt-20 pb-16 px-4 max-w-7xl mx-auto">
                <div class="relative z-10 text-center">
                    {{-- Icône de succès --}}
                    <div class="mx-auto mb-6 w-20 h-20 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center shadow-2xl">
            ...
            <div class="absolute bottom-0 left-0 right-0">
                <svg class="w-full h-12 sm:h-16" viewBox="0 0 1440 54" fill="none" preserveAspectRatio="none">
                    <path d="M0 54L60 50C120 46 240 38 360 34.7C480 31.3 600 32.7 720 34.7C840 36.7 960 39.3 1080 41.3C1200 43.3 1320 44.7 1380 45.3L1440 46V54H1380C1320 54 1200 54 1080 54C960 54 840 54 720 54C600 54 480 54 360 54C240 54 120 54 60 54H0Z" fill="#f9fafb" />
                </svg>
            </div>

            {{-- Éléments décoratifs --}}
            <div class="absolute inset-0 z-0">
                <div class="absolute top-20 right-0 w-48 h-48 md:w-72 md:h-72 bg-green-400/20 rounded-full filter blur-3xl"></div>
                <div class="absolute bottom-0 left-1/4 w-32 h-32 md:w-48 md:h-48 bg-blue-400/10 rounded-full filter blur-2xl"></div>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8 bg-gray-50 -mt-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            @if(session('shipment_created'))
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div class="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-dashed border-[#0077be]/30">
                                    ...
                                    <div class="space-y-4">
                                        <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                            <div class="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center mr-3">
                                                <svg class="w-5 h-5 text-orange-600" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M10 2L3 6v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V6l-9-4z" clip-rule="evenodd" />
                                                </svg>
                                            </div>
                                            <div>
                                                <p class="text-sm text-gray-600">Poids</p>
                                                <p class="font-semibold text-gray-900">{{ number_format($shipment['package']['weight'], 1) }} kg</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <div>
                                                ...
                                                <p class="font-semibold text-gray-900">{{ number_format($shipment['package']['price'], 2) }} €</p>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <p class="font-semibold text-gray-900">
                                                        ...
                                                        @if($shipment['package']['media_count']['videos'] > 0)
                                                            @if($shipment['package']['media_count']['images'] > 0) + @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="p-4 space-y-3">
                                    ...
                                    @if(isset($shipment['user']['password']))
                                        <div class="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                                            ...
                                            <p class="text-xs text-yellow-700 mt-1">Mot de passe: <span class="font-mono font-bold">{{ $shipment['user']['password'] }}</span></p>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                                ...
                                <div class="p-4 space-y-3">
                                    <div>
                                        <p class="text-sm text-gray-600">Nom</p>
                                        <p class="font-semibold text-gray-900">{{ $shipment['recipient']['name'] }}</p>
                                    </div>
                                    <div>
                                        <p class="text-sm text-gray-600">Téléphone</p>
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-gray-700 text-sm leading-relaxed">{{ str_replace("\n", ", ", $shipment['package']['destination']) }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                            ...
                            <div class="p-4 space-y-3">
                                ...
                                {{-- Bouton suivi --}}
                                <a href="{{ url('/tracking/' . $shipment['package']['tracking']) }}"
                                   target="_blank"
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 flex-1">
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">{{ now()->format('d/m/Y à H:i') }}</p>
                                        </div>
                                    </div>
                ...
                <div id="success-notification" class="fixed top-4 right-4 bg-white rounded-lg shadow-xl border-l-4 border-green-500 p-4 transform translate-x-full transition-transform duration-300 z-50">
