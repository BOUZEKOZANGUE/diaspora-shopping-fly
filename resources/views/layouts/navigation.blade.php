...
<div class="relative z-50" x-data="{
    ...
    <div class="bg-gradient-to-r from-[#0077be] to-[#005c91] relative pt-4 overflow-hidden"
        :class="{ 'h-12 sm:h-14': !isScrolled, 'h-10 sm:h-12': isScrolled } ">
            ...
            <div class="relative overflow-hidden h-full">
                <div class="animate-marquee whitespace-nowrap flex items-center space-x-8 h-full">
                    ...
                    <div class="inline-flex items-center space-x-6 text-white px-4">
                        ...
                        <div class="flex items-center space-x-2">
                            <i class="fas fa-globe text-[#ffd700]"></i> <!-- Icône pour le suivi en ligne -->
        ...
        <!-- Mobile Alert Scroll - Optimized for small screens -->
        <div class="sm:hidden">
            <div class="relative overflow-hidden h-full">
                <div class="animate-marquee-mobile whitespace-nowrap flex items-center h-full">
                    ...
                    <template x-for="(alert, index) in alerts" :key="index + 'mobile-duplicate'">
                        <div class="inline-flex items-center space-x-2 text-white px-3">
                            <i class="fas fa-plane-departure text-[#ffd700] text-xs"></i>
                            <span class="text-sm" x-text="alert.direction"></span>
                            <span class="text-[#ffd700] text-sm" x-text="alert.date"></span>
    ...
    <div x-show="mobileMenu" x-transition:enter="transition ease-out duration-200"
        ...
        x-transition:leave-end="opacity-0" class="fixed inset-0 bg-black/20 backdrop-blur-sm z-50 lg:hidden">

        <!-- Mobile Menu Content -->
        <div x-show="mobileMenu" @click.stop x-transition:enter="transform transition ease-out duration-300"
